...
ENGINE = create_engine('sqlite:///' + os.path.join(os.path.dirname(os.path.abspath(__file__)), 'full_llm_cache.db'))

class LLM:
    def __init__(self, default_args={'model': 'gpt-4', 'temperature': 1.0,}, seed=None,):
        self.llm = _LLM(default_args=copy.deepcopy(default_args))
...
class _LLM:
    def __init__(self, default_args={'model': 'gpt-4', 'temperature': 1.0,},):
