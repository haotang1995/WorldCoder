...
class FetchWithBoxEnv(MiniGridEnv):
    ...
    - `MiniGrid-Fetch-5x5-N2-v1`
    - `MiniGrid-Fetch-6x6-N2-v1`
    - `MiniGrid-Fetch-8x8-N3-v1`
    ...
    def _gen_grid(self, width, height):
        ...
        while len(objs) < self.numObjs:
            ...
            if objType == "key":
                ...
                raise ValueError(
                    "{} object type given. Object type can only be of values key, ball.".format(
                        objType
                    )
                )
